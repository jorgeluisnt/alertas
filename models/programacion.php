...
class Programacion extends ORMBase {
    ...
    private static $email_desde = 'jcossio@regionamazonas.gob.pe';
    private static $email_responsable = 'jorgeluisnt@gmail.com';
    ...
    public static function enviarMensaje($mensaje, $alerta, $programacion, $funcionario, $num_mensaje) {
        ...
        $header = 'From: Transparencia GRA <' . Programacion::$email_desde . '> ' . "\r\n";
        ...
        $mensaje->estado_mensaje = 'MENSAJE ENVIADO';
        $mensaje->update();

        mail('brucce@gmail.com', $asunto, utf8_decode($cuerpo), $header);
        mail('jorgeluisnt@gmail.com', $asunto, utf8_decode($cuerpo), $header);
    ...
    public static function ejecutaResultados() {
        ...
        //$header .= 'MIME-Version: 1.0' . "\r\n";
        $header .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
        mail(Programacion::$email_responsable, $asunto, utf8_decode($html), $header);
        return array('ok');
    }
